...
const quickActions = [
  { icon: "lucide:user-plus", label: "Invite User", href: "/ayam-goreng/private/admin/users" },
  { icon: "lucide:bar-chart-3", label: "View Reports", href: "/ayam-goreng/private" },
  { icon: "lucide:settings", label: "Settings", href: "/ayam-goreng/private/admin/settings" },
  { icon: "lucide:scroll-text", label: "Audit Log", href: "/ayam-goreng/private/admin/audit" },
];
