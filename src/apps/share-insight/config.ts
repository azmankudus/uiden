...
const PUBLIC_NAV = [
  ...
  { label: "Contact", icon: "lucide:phone", path: "/share-insight/public/contact" },
...
const SEARCH_PUBLIC = [
  ...
  { label: "Contact", path: "/share-insight/public/contact", icon: "lucide:phone", section: "Pages", description: "Get in touch" },
