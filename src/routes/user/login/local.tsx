...
export default function LocalLogin() {
  ...
  onMount(() => {
    if (auth.isLoggedIn()) {
      navigate(searchParams.redirect || "/apps", { replace: true });
      return;
    }
      ...
      >
        <div class="text-center mb-8">
          ...
          <h1 class="font-display text-4xl font-extrabold tracking-tight">
            <span style={{ color: "var(--color-brand)" }}>Local</span>{" "}
            <span class="text-text-primary">Account Login</span>
          </h1>
          <p class="text-text-secondary mt-2">Sign in with username and password</p>
        </div>
        ...
        <div class="bg-surface-1/80 backdrop-blur-sm border border-surface-3/60 rounded-2xl p-6 sm:p-8 shadow-xl">
          ...
          <div class="relative my-6">
            ...
            <div class="relative flex justify-center text-xs">
              <span class="bg-surface-1 px-3 text-text-muted uppercase tracking-wider">Or use other methods</span>
            </div>
          </div>
        ...
        <p class="text-center mt-6 text-sm text-text-muted">
          Page 3 of 3 - Local Authentication •{" "}
