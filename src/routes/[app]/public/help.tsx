      ...
      {(a) => (
        <div class="min-h-dvh bg-surface-0">
          <header class="flex items-center gap-3 px-5 h-[60px] bg-surface-0/80 backdrop-blur-xl border-b border-surface-3/30">
            ...
            <span class="text-xs text-text-muted px-2 py-0.5 rounded bg-surface-2 border border-surface-3">Help</span>
            <div class="flex-1" />
          ...
          <main class="max-w-3xl mx-auto px-6 py-12">
            <div classList={{ "animate-fade-up": mounted(), "opacity-0": !mounted() }}>
              ...
              <p class="text-text-secondary mb-8">Support resources for {a().name}.</p>
              ...
              <div class="space-y-4">
                <div class="p-6 rounded-2xl bg-surface-1 border border-surface-3/30">
                  ...
                  <p class="text-sm text-text-secondary">Common questions and answers for {a().name}.</p>
                </div>
                ...
                <div class="p-6 rounded-2xl bg-surface-1 border border-surface-3/30 text-center">
                  ...
                  <p class="mt-3 text-sm text-text-muted">Help content for {a().name} will appear here.</p>
                  <p class="text-xs text-text-muted mt-1">Contact: <span class="text-brand">{BRAND.supportEmail}</span></p>
                </div>
              </div>
