    ...
    <>
      ...
      <div class="pt-16 min-h-screen bg-surface-0">
        ...
        >
          ...
          <p class="text-text-secondary">The team and mission behind Kentut SuperApp.</p>
        </section>
        ...
        <section class="max-w-3xl mx-auto px-6 pb-20">
          <div class="p-6 md:p-8 rounded-2xl bg-surface-1 border border-surface-3/30">
            ...
            <p class="text-sm text-text-secondary leading-relaxed mb-4">
              Founded in 2021, Kentut SuperApp started as a simple idea: what if enterprises could access all their tools from a single, unified platform? Frustrated by fragmented workflows and clunky integrations, our founders set out to build something different.
            </p>
