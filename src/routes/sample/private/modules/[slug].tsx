...
import { slugify } from "~/lib/sample/navigation";
      ...
      <Show
        ...
        fallback={
          <div class="max-w-6xl mx-auto page-enter flex flex-col items-center justify-center py-24">
            ...
            <A href="/sample/private" class="px-4 py-2 rounded-xl text-sm font-medium bg-surface-2 text-text-primary hover:bg-surface-3">
              Back to Dashboard
            </A>
          </div>
        }
      >
        {(a) => (
          <div class="max-w-6xl mx-auto page-enter">
            <A href="/sample/private" class="inline-flex items-center gap-1 text-xs text-text-muted hover:text-text-secondary mb-6">
